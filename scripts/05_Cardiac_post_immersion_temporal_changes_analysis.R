###############################################################################
# Cardiac post-immersion temporal changes analysis (Comparing two time intervals, first and last 30 seconds, after water immersion across different temperatures)
